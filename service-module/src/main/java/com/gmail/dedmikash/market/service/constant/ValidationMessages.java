...
public class ValidationMessages {
    ...
    public static final String USER_PROFILE_NULL = "User's profile must be not null";
    ...
    public static final String ARTICLE_NAME_SIZE_NOT_VALID = "Article name must have from 1 to 100 symbols";
    public static final String ARTICLE_TEXT_SIZE_NOT_VALID = "Article text must have from 1 to 1000 symbols";
    public static final String USER_ADDRESS_SIZE_NOT_VALID = "Address  must have from 1 to 100 symbols";
    public static final String USER_TELEPHONE_SIZE_NOT_VALID = "Telephone number  must have from 1 to 13 symbols";
